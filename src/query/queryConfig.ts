...
export const queryConfigs = {
	...
	useGetRentalBanByID: { queryFn: banRentalById, queryKeys: [queryKeys.rentalban] },
	useGetRentalUnbanByID: { queryFn: unbanRentalById, queryKeys: [queryKeys.rentalban] },
	...
	useGetUserAddress: { queryFn: getUserAddress, queryKey: [queryKeys.addresses] },
	useGetAddress: { queryFn: getAllAddress, queryKey: [queryKeys.address] },
};
