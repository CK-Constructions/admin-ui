...
export interface RentalOrderDetail {
  ...
  // Order
  order_status: "confirmed" | "pending" | "completed";
  created_on: string; // ISO
  updated_on: string | null; // ISO or null

  // Rental info
  rental_name: string | null; // old
  rental_title: string; // new
