...
if (process.env.NODE_ENV === "development") {
  axios.defaults.baseURL = "http://127.0.0.1:8100/api/v1/admin";
...
//listing order
export const getAllOrders = ({ offset, limit, name, id }: TQueryParams) => _callApi(`/orders/listings?offset=${offset}&limit=${limit}&id=${id}&name=${name}`, "get");
export const getOrderByID = ({ id }: TQueryParams) => _callApi(`/orders/listings/${id}`, "get");
//service order
export const getAllServiceOrders = ({ offset, limit, name, id }: TQueryParams) => _callApi(`/orders/services?offset=${offset}&limit=${limit}&id=${id}&name=${name}`, "get");
...
//rental order
export const getAllRentalOrder = ({ offset, limit, name, id }: TQueryParams) => _callApi(`/orders/rentals?offset=${offset}&limit=${limit}&id=${id}&name=${name}`, "get");
